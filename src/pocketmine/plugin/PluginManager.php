                    ...
                    try {
                        ...
                        if ($description instanceof PluginDescription) {
                            ...
                            if ($compatible === false and $this->server->getProperty("settings.incompatible-plugins") === false) {
                                ...
                                continue;
                         //   } else {
                               // $this->server->getLogger()->warning("Loading plugin '$name' with incompatible API iversion (the plugin API is not compatible with Genisys API version " . $this->server->getApiVersion() . ")");
                            }
