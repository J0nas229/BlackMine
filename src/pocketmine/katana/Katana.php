...
class Katana
{
    ...
    public function __construct($server)
    {
        ...
        $this->logger->info(Terminal::$COLOR_GOLD . "|" . Terminal::$COLOR_PURPLE . " | | '_ ` _ \ / _` |/ _` | |/ __/ _` | |" . Terminal::$COLOR_AQUA . " |\/| | | '_ \ / _ \ "   . Terminal::$COLOR_RED . "     ImagicalMine " . $this->getFormattedVersion() . Terminal::$COLOR_GOLD . "       |");
